...
The recording menu starts a short recording from inside the TUI, stops it early if needed and exports the last recording as JSON or CSV. Export actions open a path prompt and refuse to overwrite an existing file.
